...
Source1: syslog.conf
Source2: syslogd.init
Source3: syslogd.sysconfig
Source4: klogd.init
Source5: klogd.sysconfig
...
install -pD -m755 %SOURCE2 %buildroot%_initdir/syslogd
install -pD -m640 %SOURCE3 %buildroot%_sysconfdir/sysconfig/syslogd

install -pD -m755 %SOURCE4 %buildroot%_initdir/klogd
install -pD -m640 %SOURCE5 %buildroot%_sysconfdir/sysconfig/klogd
...
- New version (1.6.0)
- Add trigger to migrate -A to -P option.
